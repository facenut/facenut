    ...
    <body>
        <div class="container">
            ...
            <div class="managermenu" style="width:160px;  margin-left:220px; padding-top: 39px;">
                ...
                <ul><a href="studentmanage.html" class="stumenu">· 학생관리</a></ul>
                <ul><a href="approve.html" class="appmenu">· 승인대기</a></ul>
                <ul style="border-bottom:1px solid darkgray;"><a href="attendance.html" class="attmenu">· 출결관리</a></ul>
            </div>
