...
<html lang="ko">
    <head>
        ...
        <style>
            ...
            tr{ height: 30px; background-color:  #fcfcfc;}
        ...
        <div class="container">
            ...
            <form action="#" method="post" name="student">
                <table>
                    ...
                    <tr>
                        <td>1</td>
                        <td><a style="text-decoration:none;">홍길동</a></td>
                        <td>빅데이터</td>
                        <td>010-1111-2222</td>
                        <td>1990.01.17</td>
                ...
                <button type="button" onclick="submitOk()" style="width:95px; height:35px; background-color: #1895be; border:none; color:white; font-size:15px; border-radius: 5px; position:absolute; bottom: 190px; right:563px; cursor:pointer;">확인</button>         
            </form>
        </div>
    </body>
    <script>
